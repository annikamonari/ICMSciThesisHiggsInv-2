...
SuperVars::SuperVars()
{
  ...
  dijet_deta             = new Variable("dijet_deta","Dijet #Delta#eta","4.2","5.1","4.2","","10","1", "");//why is there upper limit
  ...
  sqrt_ht                = new Variable("sqrt_ht","Square Root HCAL Scalar Sum of Energy","0.0","35.0","9.0",
                                        "18.0","20","1", "GeV^{0.5}");
  alljetsmetnomu_mindphi = new Variable("alljetsmetnomu_mindphi","All Jets - MET Min. #Delta#phi (No Muons)","2.0","3.15","2.0","","5","1", "");
  ...
  metnomuons             = new Variable("metnomuons","MET (No Muons)","0.0","2000","120.0","",//why the upper limit?
                                        "50","50", "GeV");
  jet1_pt                 = new Variable("jet1_pt","Jet1pt","50.0","300","50.0","","10","", "GeV");
  jet2_pt                 = new Variable("jet2_pt","Jet2pt","45.0","150","45.0","","10","", "GeV");
