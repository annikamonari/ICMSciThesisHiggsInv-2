...
//________________________________________________________________________________________________________________________________________________
	...
	{
		mva_output = new Variable("output","MVA Output","0.8425","0.843","0.8425","0.843","80","1", "", false);
	}
	...
	if (create_cards) {create_datacards(output_data_chain, output_signal_chain, output_bg_chains,
		mva_output, true, &vars, trained_output, method_name, sign, min, max, digits);}
/*
	if (create_cards) {create_datacards(output_data_chain, output_signal_chain, output_bg_chains,
			mva_output, true, &vars, trained_output, method_name, ">", min, max, digits);}
*/
